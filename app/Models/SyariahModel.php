...
class SyariahModel extends Model
{
    ...
    //    where dbo_konten.konten_parent=3
    //    order by 
    //    dbo_konten.konten_id");
       
    //    return $query->getResult();
       $query = $this->db->table('dbo_konten')
       ->where('konten_parent = 3')
    ...
    public function findSyariahById($id)
    {
        // $dbo_konten = $this
        //     ->asArray()
        //     ->where(['dbo_konten.konten_id' => $id])
        //     ->first();
