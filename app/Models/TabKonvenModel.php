...
class TabKonvenModel extends Model
{
    ...
    public function getAllTabKonven(){
        ...
        // where dbo_konten.konten_parent= 10
        // order by  
        // dbo_konten.konten_id");
    ...
    public function findTabKonvenById($id)
    {
