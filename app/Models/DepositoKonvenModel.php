...
class DepositoKonvenModel extends Model
{
    ...
    public function getAllDepositoKonven(){
    ...
    //     where dbo_konten.konten_parent= 12
    //     order by 
    //     dbo_konten.konten_id");
    ...
    public function findDepositoKonvenById($id)
    {
