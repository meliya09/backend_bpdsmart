...
class KreditStandarModel extends Model
{
    ...
    public function getAllKreditStandar(){
        ...
        // where dbo_konten.konten_parent= 25
        // order by 
        // dbo_konten.konten_id");
    ...
    public function findKreditStandarById($id)
    {
        $dbo_konten = $this
            ->asArray()
            ->where(['konten_id' => $id])
