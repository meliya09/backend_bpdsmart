...
class KirimanUangKonvenModel extends Model
{
    ...
    public function getAllKirimanUangKonven(){
        ...
        // where dbo_konten.konten_parent= 39
        // order by 
        // dbo_konten.konten_id");
    ...
    public function findKirimanUangKonvenById($id)
    {
