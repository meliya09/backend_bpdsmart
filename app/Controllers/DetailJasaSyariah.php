...
use App\Models\ DetailJasaSyariahModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception; 
 
class DetailJasaSyariah extends ResourceController
{
	protected $modelName = 'App\Models\DetailJasaSyariahModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllJasaSyariah();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailJasaSyariahById($konten_id);
