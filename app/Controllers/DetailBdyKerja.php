...
use App\Models\ DetailBdyKerjaModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailBdyKerja extends ResourceController
{
	protected $modelName = 'App\Models\DetailBdyKerjaModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllDetailSBdyKerja();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailBdyKerjaById($konten_id);
	...
	public function create(){
		...
		if ($file->move("images", $newfilename)) {
			...
			$fileModel = new DetailBdyKerjaModel();
