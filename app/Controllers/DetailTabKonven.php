...
use App\Models\DetailTabKonvenModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailTabKonven extends ResourceController
{
	protected $modelName = 'App\Models\DetailTabKonvenModel';
	protected $format = 'json';
	use ResponseTrait;
 
	public function index(){
		$posts = $this->model->getAllDetailTabKonven();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailKonvenById($konten_id);
	...
	public function create(){
		...
		if ($file->move("images", $newfilename)) {
			...
			$fileModel = new DetailTabKonvenModel();
	...
	public function approve($id = null){
		...
		$model = new DetailTabKonvenModel();
		$model->save($data);
		return $this->respond($data);
	}
	...
	public function deletegambar($id = null){
		$data = $this->model->find($id , $konten_gambar);
		if($data){
			$this->model->delete($konten_gambar);
			return $this->respondDeleted($data);
		}else{
			return $this->failNotFound('Item not found');
		}
