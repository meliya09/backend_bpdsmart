...
use App\Models\DetailGiroKonvenModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailGiroKonven extends ResourceController
{
	protected $modelName = 'App\Models\DetailGiroKonvenModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllDetailGiroKonven();
	...
	public function approve($id = null){
		...
		$model = new DetailGiroKonvenModel();
		$model->save($data);
		return $this->respond($data);
	}
