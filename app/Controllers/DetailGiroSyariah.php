...
use App\Models\DetailGiroSyariahModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailGiroSyariah extends ResourceController
{ 
	protected $modelName = 'App\Models\DetailGiroSyariahModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllDetailGiroSyariah();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailGiroSyariahById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailGiroSyariahModel();
		$model->save($data);
		return $this->respond($data);
	}
