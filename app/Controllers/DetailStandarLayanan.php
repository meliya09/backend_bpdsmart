...
use App\Models\ DetailStandarLayananModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailStandarLayanan extends ResourceController
{
	protected $modelName = 'App\Models\DetailStandarLayananModel';
	protected $format = 'json'; 
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllDetailLayanan();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailLayananById($konten_id);
	...
	public function create(){
		...
		if ($file->move("images", $newfilename)) {
			...
			$fileModel = new DetailStdLayananModel();
