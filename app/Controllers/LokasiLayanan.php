...
use App\Models\LokasiLayananModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class LokasiLayanan extends ResourceController
{
	protected $modelName = 'App\Models\LokasiLayananModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllLokasiLayanan();
		return $this->respond($posts);
	}

	public function show($id = null){
		$data = $this->model->findLokasiLayananById($id);
