...
use App\Models\DetailDepoSyariahModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailDepoSyariah extends ResourceController
{
	protected $modelName = 'App\Models\DetailDepoSyariahModel';
	protected $format = 'json';
	use ResponseTrait; 

	public function index(){
		$posts = $this->model->getAllDetailDepoSyariah();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailDepoSyariahById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailDepoSyariahModel();
		$model->save($data);
		return $this->respond($data);
	}
