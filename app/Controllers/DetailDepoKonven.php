...
use App\Models\DetailDepoKonvenModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailDepoKonven extends ResourceController
{
	protected $modelName = 'App\Models\DetailDepoKonvenModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllDetailDepoKonven();
	...
	public function approve($id = null){
		...
		$model = new DetailDepoKonvenModel();
		$model->save($data);
		return $this->respond($data);
	}
