...
use App\Models\ DetailKreditProgramModel;
use CodeIgniter\RESTful\ResourceController; 
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailKreditProgram extends ResourceController
{
	protected $modelName = 'App\Models\DetailKreditProgramModel';
	protected $format = 'json';
	use ResponseTrait; 

	public function index(){
		$posts = $this->model->getAllKreditProgram();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailKreditProgramById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailKreditProgramModel();
		$model->save($data);
		return $this->respond($data);
	}
