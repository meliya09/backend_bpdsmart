...
use App\Models\ DetailKirimanUangSyariahModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception; 
 
class DetailKirimanUangSyariah extends ResourceController
{
	protected $modelName = 'App\Models\DetailKirimanUangSyariahModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllKirimanUangSyariah();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailKirimanUangSyariahById($konten_id);
