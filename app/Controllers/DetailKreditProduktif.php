...
use App\Models\ DetailKreditProduktifModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailKreditProduktif extends ResourceController
{ 
	protected $modelName = 'App\Models\DetailKreditProduktifModel';
	protected $format = 'json'; 
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllKreditProduktif();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailKreditProduktifById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailKreditProduktifModel();
		$model->save($data);
		return $this->respond($data);
	}
