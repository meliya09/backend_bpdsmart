...
use App\Models\ DetailIdentitasModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailIdentitas extends ResourceController
{
	protected $modelName = 'App\Models\DetailIdentitasModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllDetailIdentitas();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailIdentitasById($konten_id);
	...
	public function create(){
		...
		if ($file->move("images", $newfilename)) {
			...
			$fileModel = new DetailIdentitasModel();
