...
use App\Models\ DetailStdLayananModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailStdLayanan extends ResourceController
{
	protected $modelName = 'App\Models\DetailStdLayananModel';
	protected $format = 'json'; 
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllDetailStdLayanan();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailStdLayananById($konten_id);
