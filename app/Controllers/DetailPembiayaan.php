...
use App\Models\ DetailPembiayaanModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailPembiayaan extends ResourceController
{
	protected $modelName = 'App\Models\DetailPembiayaanModel'; 
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllPembiayaan();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailPembiayaanById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailPembiayaanModel();
		$model->save($data);
		return $this->respond($data);
	}
