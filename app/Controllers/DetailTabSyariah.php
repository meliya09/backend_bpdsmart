...
use App\Models\DetailTabSyariahModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailTabSyariah extends ResourceController
{
	protected $modelName = 'App\Models\DetailTabSyariahModel';
	protected $format = 'json';
	use ResponseTrait;
 
	public function index(){
		$posts = $this->model->getAllDetailTabSyariah();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailSyariahById($konten_id);
	...
	public function create(){
		...
		if ($file->move("images", $newfilename)) {
			...
			$fileModel = new DetailTabSyariahModel();
	...
	public function approve($id = null){
		...
		$model = new DetailTabSyariahModel();
		$model->save($data);
		return $this->respond($data);
	}
