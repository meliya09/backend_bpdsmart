...
use App\Models\ DetailKirimanUangModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailKirimanUang extends ResourceController
{
	protected $modelName = 'App\Models\DetailKirimanUangModel';
	protected $format = 'json';
	use ResponseTrait;
 
	public function index(){
		$posts = $this->model->getAllDetailKirimanUang();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailKirimanUangById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailKirimanUangModel();
		$model->save($data);
		return $this->respond($data);
	}
