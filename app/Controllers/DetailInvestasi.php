...
use App\Models\ DetailInvestasiModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface; 
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailInvestasi extends ResourceController
{
	protected $modelName = 'App\Models\DetailInvestasiModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){
		$posts = $this->model->getAllDetailInvestasi();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailInvestasiById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailInvestasiModel();
		$model->save($data);
		return $this->respond($data);
	}
