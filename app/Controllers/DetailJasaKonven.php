...
use App\Models\ DetailJasaKonvenModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailJasaKonven extends ResourceController
{
	protected $modelName = 'App\Models\DetailJasaKonvenModel';
	protected $format = 'json';
	use ResponseTrait; 

	public function index(){
		$posts = $this->model->getAllJasaKonven();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailJasaKonvenById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailJasaKonvenModel();
		$model->save($data);
		return $this->respond($data);
	}
