...
use App\Models\ DetailKreditKonsumerModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailKreditKonsumer extends ResourceController
{
	protected $modelName = 'App\Models\DetailKreditKonsumerModel';
	protected $format = 'json';
	use ResponseTrait;

	public function index(){ 
		$posts = $this->model->getAllKreditKonsumer();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailKreditKonsumerById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailKreditKonsumerModel();
		$model->save($data);
		return $this->respond($data);
	}
