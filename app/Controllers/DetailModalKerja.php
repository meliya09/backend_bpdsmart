...
use App\Models\ DetailModalKerjaModel;
use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\HTTP\ResponseInterface;
use CodeIgniter\API\ResponseTrait;
use Exception;
 
class DetailModalKerja extends ResourceController
{
	protected $modelName = 'App\Models\DetailModalKerjaModel';
	protected $format = 'json';
	use ResponseTrait;
 
	public function index(){
		$posts = $this->model->getAllModalKerja();
		return $this->respond($posts);
	}

	public function show($konten_id = null){
		$data = $this->model->findDetailModalKerjaById($konten_id);
	...
	public function approve($id = null){
		...
		$model = new DetailModalKerjaModel();
		$model->save($data);
		return $this->respond($data);
	}
